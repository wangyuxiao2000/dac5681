...
# glbl_cfg5_ibuf0_mode[4:1] = 0xB
dut.write(0xA, 0x17)

# glbl_cfg5_ibuf1_en[0:0] = 0x1
# glbl_cfg5_ibuf1_mode[4:1] = 0xB
dut.write(0xB, 0x17)

# glbl_cfg5_ibuf2_en[0:0] = 0x1
# glbl_cfg5_ibuf2_mode[4:1] = 0xB
dut.write(0xC, 0x17)

# glbl_cfg5_ibuf3_en[0:0] = 0x1
# glbl_cfg5_ibuf3_mode[4:1] = 0xB
dut.write(0xD, 0x17)
...
# pll1_cfg1_cpendn[3:3] = 0x0
# pll1_cfg1_cpenup[4:4] = 0x0
dut.write(0x1B, 0x0)
...
# pll1_cfg5_lkdtimersetpt[4:0] = 0xC
...
# pll2_vdiv_cfg16_divratio_lsb[7:0] = 0x2C
dut.write(0x35, 0x2C)

# pll2_vdiv_cfg16_divratio_msb[7:0] = 0x1
dut.write(0x36, 0x1)
...
# pll1_ro7_dac_avg[6:0] = 0x0
dut.write(0x83, 0x0)

# pll1_ro7_dac_current[6:0] = 0x0
...
# pll2_ro8_tunestatus[7:0] = 0x0
dut.write(0x8C, 0x0)

# pll2_ro8_vtune_error_lsb[7:0] = 0x0
dut.write(0x8D, 0x0)
...
# clkgrp2_div1_cfg12_divrat_lsb[7:0] = 0x18
dut.write(0xDD, 0x18)
...
# clkgrp3_div1_cfg12_divrat_lsb[7:0] = 0x3
dut.write(0xF1, 0x3)
...
# clkgrp3_div2_cfg12_divrat_msb[3:0] = 0x6
dut.write(0xFC, 0x6)
...
# clkgrp4_div1_cfg12_divrat_lsb[7:0] = 0x3
dut.write(0x105, 0x3)
...
# clkgrp4_div2_cfg12_divrat_lsb[7:0] = 0x3
dut.write(0x10F, 0x3)
...
# clkgrp5_div1_cfg12_divrat_lsb[7:0] = 0x18
dut.write(0x119, 0x18)
...
# clkgrp5_div2_cfg12_divrat_msb[3:0] = 0x6
dut.write(0x124, 0x6)
...
# clkgrp6_div1_cfg12_mslip_lsb[7:0] = 0xF
dut.write(0x131, 0xF)
...
# clkgrp7_div1_cfg12_divrat_lsb[7:0] = 0xC
dut.write(0x141, 0xC)
